...
// API Keys
const MAPS_API_KEY = 'AIzaSyBfm6buWpcBCboQklp0B4lbhPOK8_Nm7K8'
const GEOCODING_API_KEY = 'AIzaSyBMbiiTB4C5ogOpIQ9s2YpQMlU6zRCuopo'
...
function lookupAddressGeo(geoOrAddress) {
    var url = `https://maps.googleapis.com/maps/api/geocode/json?key=${GEOCODING_API_KEY}&`
...
function _connectGoogleApi() {
    ...
    elGoogleApi.src = `https://maps.googleapis.com/maps/api/js?key=${MAPS_API_KEY}`
